...
export const DEFAULT_BUSINESS_SETTINGS: BusinessSettings = {
  ...
  tallerAddress: 'Av. Insurgentes Sur #450, Piso 2, Interior 204',
  tallerNeighborhood: 'Col. Roma Sur, Alcaldía Cuauhtémoc',
  tallerCityState: 'Ciudad de México, CDMX',
  tallerPostalCode: '06760',
  tallerReferences: 'Entre calles Bajío y Viaducto, frente a estación Metrobús Chilpancingo',
  googleMapsUrl: 'https://maps.google.com/?q=Av.+Insurgentes+Sur+450+Roma+Sur+CDMX',
